...
\begin{table}[H]
	\centering
	\begin{tabularx}{\textwidth}{|l|X|r|} % sửa l/r/X/| theo số cột
		\hline
		\textbf{STT} & \textbf{Nội dung}                                                 & \textbf{Số lượng} \\
		\hline
		1            & Đây là nội dung rất dài, LaTeX sẽ tự xuống dòng trong ô nhờ cột X & 10                \\
		\hline
		2            & \centering Nội dung thứ 2, có thể dài nhiều dòng                             & 5                 \\
		\hline
	\end{tabularx}
